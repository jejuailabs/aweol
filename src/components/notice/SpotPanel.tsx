        ...
        {isStaff && (
          <>
            <button
              ...
              disabled={removing}
              className="float-right rounded-full px-2.5 py-1 text-[12px] font-bold disabled:opacity-40"
    ...
    <>
      ...
      {list.length === 0 ? (
        <div className="py-10 text-center">
          ...
          <div className="text-sm" style={{ color: '#A89880' }}>아직 만들어진 놀이가 없어요</div>
        </div>
      ) : (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex gap-1.5 mt-1">
                  <span className="rounded-full px-2 py-0.5 text-[11px] font-bold" style={{ background: '#E8A33C20', color: '#A6762A' }}>
                    {g.spotCount}군데
                  </span>
